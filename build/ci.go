...
import (
	...
	"github.com/sesafoundation/sesn/crypto/signify"
	"github.com/sesafoundation/sesn/internal/build"
...
var (
	...
	debExecutables = []debExecutable{
		...
		{
			BinaryName:  "setd",
			Description: "SESA Network CLI client.",
		},
		{
			BinaryName:  "puppeth",
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/sesafoundation/sesn/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/sesafoundation/sesn/mobile")
