...
import (
	...
	"github.com/sesafoundation/sesn/console/prompt"
...
const (
	clientIdentifier = "setd" // Client identifier to advertise over the network
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the setd command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2020 The go-ethereum Authors and SESN Authors"
	app.Commands = []cli.Command{
		...
		withdrawValidatorStarCommand,
		withdrawDelegatorStarCommand,
		withdrawDelegatorGoldCommand,
...
func prepare(ctx *cli.Context) {
	...
	case ctx.GlobalIsSet(utils.TestnetFlag.Name):
		log.Info("Starting setd on testnet...")

	case ctx.GlobalIsSet(utils.DeveloperFlag.Name):
		log.Info("Starting setd in ephemeral dev mode...")

	case !ctx.GlobalIsSet(utils.NetworkIdFlag.Name):
		log.Info("Starting setd on mainnet...")
	}
...
//	debug.Memsize.Add("node", stack) // disable for go24
