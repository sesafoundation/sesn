module github.com/sesafoundation/sesn
...
require (
	...
	//	xxxgithub.com/decred/dcrd/dcrec/xxxsecp256k1/v4 v4.0.1 // indirect
	//github.com/ethereum/go-ethereum v1.16.7
	github.com/sesafoundation/sesn/crypto/secp256k1   // /v4 v4.0.1
