...
func (b *EthAPIBackend) BlockChain() *core.BlockChain    { return b.eth.BlockChain() }
func (b *EthAPIBackend) ChainConfig() *params.ChainConfig { return b.eth.ChainConfig() }
...
///////////end core chain access
//////////////state access

func (b *EthAPIBackend) StateAndHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*state.StateDB, *types.Header, error) {
    if number == rpc.PendingBlockNumber {
        block, st := b.eth.Miner().Pending()
...
func (b *EthAPIBackend) GetEVM(ctx context.Context, msg core.Message, stateDb *state.StateDB, header *types.Header) (*vm.EVM, func() error, error) {
    vmError := func() error { return nil }

    txContext := core.NewEVMTxContext(msg)
    blockCtx := core.NewEVMBlockContext(header, b.eth.BlockChain(), nil)
    return vm.NewEVM(blockCtx, txContext, stateDb, b.eth.BlockChain().Config(), *b.eth.BlockChain().GetVMConfig()), vmError, nil
}


/// end receipt logs td evm
